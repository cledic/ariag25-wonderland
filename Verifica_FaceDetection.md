...
// *********************************************
#define OPENCV_ROOT  "/usr/local/share/opencv"
// *********************************************


void displayDetections(IplImage * pInpImg, CvSeq * pFaceRectSeq);
void FaceDetections(IplImage * pInpImg, CvSeq * pFaceRectSeq);
...
int main(int argc, char** argv)
{
	...
	pCascade = (CvHaarClassifierCascade *)cvLoad
	   ((OPENCV_ROOT"/haarcascades/haarcascade_frontalface_default.xml"),
	   0, 0, 0 );
	...
	FaceDetections(pInpImg, pFaceRectSeq);
...
void FaceDetections(IplImage * pInpImg, CvSeq * pFaceRectSeq)
{
	...
	if ( !cvSaveImage( "res.png", pInpImg)) {
		printf("Errore nel salvare res.png\n");
	} else {
		printf("OK salvataggio res.png\n");
	}
}
